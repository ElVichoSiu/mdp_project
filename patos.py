...
Código para crear dataset a partir de datos de Wikipedia https://en.wikipedia.org/wiki/Lists_of_works_of_fiction_made_into_feature_films 
Laura Maldonado Lagos, Vicente Thiele Muñoz y Javiera Romero Orrego Grupo 2
